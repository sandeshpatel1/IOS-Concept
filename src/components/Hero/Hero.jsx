...
import { HiArrowDown, HiOutlineDocumentArrowDown } from 'react-icons/hi2';
      ...
      <div className="hero-grid container">
        <motion.div className="hero-content" style={{ y: textY }}>
          ...
          <motion.div className="hero-cta-row"
            ...
            {/* Resume lives here on mobile now — the mobile tab bar dropped
                it to keep all 5 tabs evenly spaced (desktop pill nav still
                has its own Resume button, so this is mobile-only). */}
            <a
              href={resumeUrl} target="_blank" rel="noreferrer"
              className="ios-btn ios-btn-glass hero-resume-mobile"
            >
